...
<div class="container">
    <article class="card">
        ...
        <div class="card-body">
            <h6 style="margin-bottom: 14px;">Order ID: OD45345345435</h6>
            <article class="card">
            ...
            <hr class="mb-3">
            <a href="trangchu" class="btn btn-warning" data-abc="true"> <i class="fa fa-chevron-left"></i> Back to orders</a>
        </div>
    </article>
</div>