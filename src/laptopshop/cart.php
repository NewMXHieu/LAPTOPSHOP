            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered m-0">
                        <thead>
                            <tr>
                                <th class="text-center py-3 px-4" style="min-width: 400px;">Tên laptop &amp; chi tiết</th>
                            ...
                            <tr>
                                <td class="p-4">
                                    <div class="media align-items-center">
                                        <img src="static/image/products/<?= htmlspecialchars($image) ?>" class="d-block ui-w-40 ui-bordered mr-4" alt>
                                        <div class="media-body">
                                            <a href="#" class="d-block text-dark"><?= htmlspecialchars($name) ?></a>
                                            <small>
                                                <span class="text-muted">Màu:</span>
                                                <span class="ui-product-color ui-product-color-sm align-text-bottom" style="background:<?= htmlspecialchars($colorCode) ?>;"></span> &nbsp;
                                                <span class="text-muted">Storage: </span><?= htmlspecialchars($storage) ?> &nbsp;
                                            </small>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="text-center align-middle px-0">
                                    <button class="shop-tooltip close float-none text-danger" title data-original-title="Remove" onclick="deleteFromCart('<?= htmlspecialchars($cart_id) ?>', '<?= htmlspecialchars($id) ?>'); return false;">×</button>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
                ...
                <div class="float-right">
                    <a href="trangchu"><button type="button" class="btn btn-lg btn-default md-btn-flat mt-2 mr-3">Back to shopping</button></a>
